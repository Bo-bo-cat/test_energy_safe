export const en = {
  ...
  faq: {
    ...
    contactSubtitle: 'Write to us — we will respond as soon as possible',
  ...
  picker: {
    ...
    batteryPlaceholder: 'e.g. 100Ah or 1200Wh',
    autonomyLabel: 'Estimated autonomy',
    autonomyPlaceholder: 'e.g. 4-6 hrs',
  },
